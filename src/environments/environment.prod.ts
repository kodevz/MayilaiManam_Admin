...
export const environment = {
    production: true,
    clientSecret: 'KfsjpDWDrYXG7nFjVTwPOZAwAEdwQJCbMJnrNx5z',
    clientId: 2,
    grantType: 'password',
};

// export const ApiHosts = {
//     oauth : 'http://192.168.43.154/laravel6/mm/oauth/',
//     api : 'http://192.168.43.154/laravel6/mm/api/',
//     web : 'http://192.168.43.154/laravel6/mm/'
// }


export const ApiHosts = {
    oauth: 'https://shaorg.com/oauth/',
    api: 'https://shaorg.com/api/',
    web: 'https://shaorg.com/'
}
